  ...
  if (screen === 1) {
    ...
    if (event.keyCode === 119) {
      ...
      setTimeout(function () {
        ...
        message_box_typewriter.typeString("").deleteAll();
        message_box_typewriter.typeString("Press Y to go back to the basement.").start();
      }, 2000);
    ...
    if (event.keyCode === 120) {
      ...
      setTimeout(function () {
        ...
        message_box_typewriter.typeString("").deleteAll();
        message_box_typewriter.typeString("Press Y to go back to the second floor.").start();
      }, 2000);
    ...
    if (event.keyCode === 120) {
      ...
      setTimeout(function () {
        ...
        message_box_typewriter.typeString("").deleteAll();
        message_box_typewriter.typeString("Press X to go back to the bedroom.").start();
      }, 2000);
